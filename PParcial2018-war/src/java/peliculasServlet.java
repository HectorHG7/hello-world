 ...
 * @author Hector
 */
@WebServlet(urlPatterns = {"/peliculasServlet"})
public class peliculasServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            List<Category> lc= categoryFacade.findAll();
            List<Rating> lr = ratingFacade.findAll();
            List<Language> lg=languageFacade.findAll();
